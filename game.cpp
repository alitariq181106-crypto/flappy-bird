...
void init() {
    ...
    pipe1.pos = Vec2 (WINDOW_WIDTH/3,0);
    pipe1.vel = Vec2(0,0);
    pipe1_top.pos = Vec2(WINDOW_WIDTH/3,WINDOW_HEIGHT);
    pipe2.pos = Vec2 (WINDOW_WIDTH*2/5,0);
    pipe2_top.pos = Vec2(WINDOW_WIDTH*2/5,WINDOW_WIDTH);
